...
// {'\n'} enter kalimat 
export default function Resepbuah2({navigation}) {
    return(
        <ScrollView style="flex: 1">
            ...
            <Image source={require('../imgbuah/buah3.jpeg')} style={{ width: 393, height: 300, marginTop: -67}}/>
            <View style={{ backgroundColor: '#829460', width: 393, height: 55, alignContent: 'center', alignItems: 'center', borderBottomLeftRadius: 15, borderBottomRightRadius: 15}}>
                <Text style={{ color: '#ffffff', fontSize: 25, fontWeight: '500', marginTop: 10, fontFamily: 'Poppins-Medium'}}>SALAD BUAH</Text>
            </View>
            </View>
            ...
            <View style={{ marginLeft: 30, marginRight: 30, marginTop: 20,}}>
                ...
                - 8 buah raspberi{'\n'}
                - 1 jeruk, kupas{'\n'}
                - 6 buah stroberi, potong-potong{'\n'}
                - 10 buah anggur{'\n'}
                - 8 buah bluberi{'\n'}
                - 3 kiwi, kupas dan potong-potong{'\n'}
                - 2 apel, kupas dan potong-potong{'\n'}
                - 1 mangga, kupas dan potong-potong{'\n'}
                - Madu dan perasan jeruk secukupnya{'\n'}
                
                {'\n'}{'\n'}
                <Text style={{ color: 'black', fontSize: 18 }}>Cara Membuat:</Text>{'\n'}
                - Taruh semua buah ke dalam mangkuk. Beri madu dan perasan jeruk. Lalu aduk rata.{'\n'}
                - Langsung sajikan.{'\n'} 
                </Text>
            </View>
        </ScrollView>
