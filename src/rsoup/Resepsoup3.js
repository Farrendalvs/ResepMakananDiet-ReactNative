...
// {'\n'} enter kalimat 
export default function Resepsoup3({navigation}) {
    return(
        <ScrollView style="flex: 1">
            ...
            <Image source={require('../imgsoup/soup4.png')} style={{ width: 393, height: 300, marginTop: -67}}/>
            <View style={{ backgroundColor: '#829460', width: 393, height: 55, alignContent: 'center', alignItems: 'center', borderBottomLeftRadius: 15, borderBottomRightRadius: 15}}>
                <Text style={{ color: '#ffffff', fontSize: 25, fontWeight: '500', marginTop: 10, fontFamily: 'Poppins-Medium'}}>SOUP AYAM JAHE</Text>
            </View>
            </View>
            ...
            <View style={{ marginLeft: 30, marginRight: 30, marginTop: 20,}}>
                ...
                - 3 buah wortel dikupas dan potong-potong{'\n'}
                - 1 brokoli ukuran kecil{'\n'}
                - 2 batang daun bawang di potong ukuran sedang{'\n'}
                - 1 buah jahe sepanjang jempol digeprak{'\n'}
                {'\n'}
                Bumbu Cincang Kasar:{'\n'}
                ...
                - Kemudian sajikan di dalam gelas dan smoothie siap dinikmati.{'\n'}
                </Text>
            </View>
        </ScrollView>
    )
